      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">1. Terms</h2>
            <p className="mb-4">
              By accessing this web site, you are agreeing to be bound by these web site Terms and Conditions of Use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this web site are protected by applicable copyright and trade mark law.
            </p>

            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">2. Use License</h2>
            <p className="mb-4">
              Permission is granted to temporarily download one copy of the materials (information or software) on Bambini's World's web site for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>modify or copy the materials;</li>
              <li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
              <li>attempt to decompile or reverse engineer any software contained on Bambini's World's web site;</li>
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">5. Revisions and Errata</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">6. Links</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">7. Site Terms of Use Modifications</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">8. Governing Law</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-8 mb-4">Privacy Policy</h2>
            <p className="mb-4">
