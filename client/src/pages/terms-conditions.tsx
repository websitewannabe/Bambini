...
export default function TermsConditions() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Terms and Conditions - Bambini's World</title>
        <meta name="description" content="Read the terms and conditions for using Bambini's World website and services." />
        <meta name="robots" content="noindex" />
      </Helmet>
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-navy mb-6">Terms and Conditions</h1>
          <div className="prose prose-lg max-w-none">
            
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">CONDITIONS OF USE</h2>
            
            <p className="mb-4">
              Welcome to our online store! Bambini's World and its associates provide their services to you subject to the following conditions. If you visit or shop within this website, you accept these conditions. Please read them carefully. PRIVACY Please review our Privacy Notice, which also governs your visit to our website, to understand our practices.
            </p>

            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">ELECTRONIC COMMUNICATIONS</h2>
            <p className="mb-4">
              When you visit Bambini's World or send e-mails to us, you are communicating with us electronically. You consent to receive communications from us electronically. We will communicate with you by e-mail or by posting notices on this site. You agree that all agreements, notices, disclosures and other communications that we provide to you electronically satisfy any legal requirement that such communications be in writing.
            </p>

            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">COPYRIGHT</h2>
            <p className="mb-4">
              All content included on this site, such as text, graphics, logos, button icons, images, audio clips, digital downloads, data compilations, and software, is the property of Bambini's World or its content suppliers and protected by international copyright laws. The compilation of all content on this site is the exclusive property of Bambini's World with copyright authorship for this collection by Bambini's World and protected by international copyright laws.
            </p>

            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">TRADE MARKS</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">LICENSE AND SITE ACCESS</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">YOUR MEMBERSHIP ACCOUNT</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">REVIEWS, COMMENTS, EMAILS, AND OTHER CONTENT</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">RISK OF LOSS</h2>
            <p className="mb-4">
              All items purchased from Bambini's World are made pursuant to a shipment contract. This basically means that the risk of loss and title for such items pass to you upon our delivery to the carrier.
            </p>

            <h2 className="text-2xl font-semibold text-navy mt-6 mb-4">PRODUCT DESCRIPTIONS</h2>
            <p className="mb-4">
